...
public class ItemDetailsActivity extends BaseActivity {
    ...
    private TransactionItemBean itemBean;
    ...
    protected void initView() {
        itemBean = (TransactionItemBean) getIntent().getSerializableExtra("DATA");
        boolean isflag=getIntent().getBooleanExtra("Flag",false);
        if (isflag){
            tv_flag.setText("Sold");
        }
        SYS = itemBean.getSymBol();
    ...
    private void initDataView() {
        tvSymbolTop.setText(itemBean.getSymBol());
        tvAmount.setText(itemBean.getAmount());
        tvPrice.setText("$"+itemBean.getUnitPrice());
        tvTprice.setText("$"+Integer.valueOf(itemBean.getAmount())*Integer.valueOf(itemBean.getUnitPrice()));
        tvDate.setText(itemBean.getData());
