...
public class AddItemActivity extends BaseActivity {
    ...
    protected int setLayoutViewById() {
        return R.layout.activity_additme;
    }
        ...
        switch (view.getId()){
            case R.id.tv_sumbit:
                ...
                if(TextUtils.isEmpty(sym)){
                    ToastUtils.showShortToast("Symbol cannot be empty",AddItemActivity.this);
                    return;
                }
                if(TextUtils.isEmpty(amout)){
                    ToastUtils.showShortToast("Amount cannot be empty",AddItemActivity.this);
                    return;
                }
                if(TextUtils.isEmpty(price)){
                    ToastUtils.showShortToast("Price cannot be empty",AddItemActivity.this);
                    return;
                }
                if(TextUtils.isEmpty(date)){
                    ToastUtils.showShortToast("Date cannot be empty",AddItemActivity.this);
                    return;
                }
    ...
    public void getBook(final TransactionItemBean itemBean) {
                ...
                new SubscriberOnNextListener<JsonObject>() {
                    ...
                    public void OnSuccess(JsonObject loginResponse) {
                        ...
                        if (jsonArray != null) {
                            ...
                            ToastUtils.showShortToast("Purchase success",AddItemActivity.this);
                            finish();
                        } else {
                            ToastUtils.showShortToast("Please enter the correct Symbol",AddItemActivity.this);
                        }
                    }
